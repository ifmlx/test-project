	...
	run: async (client, message, args) => {
		try {
			...
			if (args[0]) {
				...
				//oldgaming
				if (args[0].toLowerCase().startsWith("o")) link = "https://youtube.com/playlist?list=PLkngaZ39XpCeCvtg13T0HEkb1BjXFC1Dx"
				//gaming
				...
				//magic-release
				if (args[0].toLowerCase().startsWith("ma")) link = "https://www.youtube.com/watch?v=rvMSo0Oyw1M"
				//metal
